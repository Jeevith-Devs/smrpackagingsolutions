    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative bg-white rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden z-10 border border-slate-200 font-the-future"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-4 border-t border-slate-100">
              ...
              >
                ...
                <span>Get WhatsApp Quote for {product.name}</span>
              </button>
            </div>
